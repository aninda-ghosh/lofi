...
class ImageEncoder(nn.module):
    def __init__(self, image_size=224, num_channels=3, pretrain=True):
        super().__init__()
        ...
        self.swinModel = SwinModel(self.swinConfig)
    ...
    def forward(self, pixel_values, bool_masked_pos):
        outputs = self.swinModel(pixel_values, bool_masked_pos=bool_masked_pos)
