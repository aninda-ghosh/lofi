...
_C.MODEL.CL.GPS_QUEUE_SIZE = 2048
_C.MODEL.CL.TRAINING = CN()
_C.MODEL.CL.TRAINING.LEARNING_RATE = 1e-6
_C.MODEL.CL.TRAINING.WEIGHT_DECAY = 1e-8
_C.MODEL.CL.TRAINING.BATCH_SIZE = 64
_C.MODEL.CL.TRAINING.MAX_EPOCHS = 15
_C.MODEL.CL.TRAINING.NUM_WORKERS = 8
_C.MODEL.CL.TRAINING.SWA_LRS = 1e-3

# Self Supervised Learning Validation
_C.MODEL.CL.VALIDATION = CN()
_C.MODEL.CL.VALIDATION.BATCH_SIZE = 32
